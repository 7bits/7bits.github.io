---
layout: post
title: "О курсах для бизнесменов в IT-lift"
...
Изначально этот текст был [опубликован](https://vk.com/itliftomsk?w=wall-58952501_1001) Анной Тарасенко в [группе](https://vk.com/itliftomsk) IT-lift Вконтакте. Далее от первого лица (ссылки заменены на актуальные). 
...
1. Читаю книги. Вот такие, например: http://7bits.it/#books.
2. Слушаю подкасты. Вот такие, например: http://sharkov.podfm.ru/
3. Читаю каналы в телеграме. Вот такие, например: https://t.me/temno, https://t.me/startupoftheday
4. Бываю на мероприятиях, организованных ФРИИ, в том числе в декабре 2016 оказалась прямо внутри ФРИИ, где был разбор полетов работы акселератора, на котором собрались все: трекеры обоих акселераторов, региональные представители от Калининграда до Петропавловска Камчатского, руководители обоих акселераторов, преподаватели ВШЭ и менторы ФРИИ. Было безумно познавательно, уровень прокачки не поддается оценке.
5. Провожу мероприятия. Вот такие, например: http://magickickstartup.ru/ В 2017-м у нас были только действующие бизнесмены, никаких студентов в розовых очках 😊 И мы с ними взаимно обогатились знаниями.
...
[Страница специальности с регистрацией](http://itlift.1der.link/courses/internet-business).